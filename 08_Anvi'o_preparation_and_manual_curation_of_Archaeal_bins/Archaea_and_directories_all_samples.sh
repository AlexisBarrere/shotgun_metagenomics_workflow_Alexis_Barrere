...
create_files_and_collections_for_all_samples() {
  ...
  cp -r "/mnt/c/Users/alexi/Documents/Cours/Stage Copenhague 2025/Stage 2025/Anvi_summarize/sample_$i/PROFILE.db" $INPUT_FILES

  cp -r "/mnt/c/Users/alexi/Documents/Cours/Stage Copenhague 2025/Stage 2025/Anvi_summarize/sample_$i/AUXILIARY-DATA.db" $INPUT_FILES

  cp -r "/mnt/c/Users/alexi/Documents/Cours/Stage Copenhague 2025/Stage 2025/Anvi_summarize/sample_$i/sample_${i}_contigs_copy.db" $INPUT_FILES

  cp -r "/mnt/c/Users/alexi/Documents/Cours/Stage Copenhague 2025/Stage 2025/Anvi_summarize/sample_$i/sample_${i}_summary/bins_summary.txt" $INPUT_FILES
  ...
  COLLECTION_NAME_ARCHAEA=${COLLECTION_NAME}_Archaea
  ...
  SUMMARIZE_V1=$ANVI_SUMMARIZE_DIR/sample_${i}_Archaea_V1_summarize
...
export -f create_files_and_collections_for_all_samples

# === Run the function ===
for i in $(seq -w 1 24); do
  create_files_and_collections_for_all_samples $i
done
