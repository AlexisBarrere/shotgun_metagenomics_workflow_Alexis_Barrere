...
# Read the fifth line (the T6_N1P2K2 group) and pass the columns to the function
read GROUP S1 S2 S3 S4 < <(sed -n '5p' ~/Stage_Copenhague/assembly/coassembly_groups.tsv)
