...
# Read the second line (the T3_N1K1 group) and pass the columns to the function
read GROUP S1 S2 S3 S4 < <(sed -n '2p' ~/Stage_Copenhague/assembly/coassembly_groups.tsv)
